...
class _WorkoutPlannerPageState extends State<WorkoutPlannerPage> {
  ...
  Widget _buildWorkoutCard(BuildContext context, WorkoutController workoutController,
      Map<String, dynamic> exercise) {
    String exerciseName = exercise['exercise_name'];
    String exerciseImage = exercise['image'] ?? 'assets/images/default.png'; 
    bool isCompleted =
        workoutController.completedExercises[exerciseName] ?? false;
              ...
              Row(
                ...
                children: [
                  ...
                  IconButton(
                    ...
                    onPressed: () {
                      workoutController.markAsCompleted(exerciseName);
                    },
                  ),
                ],
              ),
